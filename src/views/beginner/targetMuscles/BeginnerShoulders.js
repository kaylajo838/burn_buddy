...
export default function BeginnerShoulders() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(beginner => {
                ...
                return beginner.Difficulty === 'Beginner' && beginner.target && beginner.target.Primary && beginner.target.Primary.includes('Shoulders')
            })
