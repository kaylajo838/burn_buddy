...
export default function BeginnerChest() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(beginner => {
                ...
                return beginner.Difficulty === 'Beginner' && beginner.target && beginner.target.Primary && beginner.target.Primary.includes('Chest')
            })
