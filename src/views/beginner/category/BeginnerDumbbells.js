...
export default function BeginnerDumbbells() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(beginner => {
                ...
                return beginner.Difficulty === 'Beginner' && beginner.Category && beginner.Category && beginner.Category.includes('Dumbbells')
            })
  ...
  return (
    <div style={{ marginRight: '40px', marginLeft: '40px', marginBottom: '40px'}}>
        <Button sx={{margin: '20px'}} onClick={() => navigate('/beginnerCategory')}>Back</Button>
        <Box sx={{
            display: 'flex',
