...
export default function BeginnerKettlebells() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(beginner => {
                ...
                return beginner.Difficulty === 'Beginner' && beginner.Category && beginner.Category && beginner.Category.includes('Kettlebells')
            })
