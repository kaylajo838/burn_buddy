...
export default function BeginnerAllWorkouts() {
    ...
    const handleExpandClick = (index) => {
        setBeginnerWorkout(prevWorkouts =>
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(beginner => {
  ...
  return (
    <div style={{ marginRight: '40px', marginLeft: '40px', marginBottom: '40px'}}>
        ...
        <Box sx={{
            ...
            {beginnerWorkout.slice((page - 1) * itemsPerPage, page * itemsPerPage).map((workout, index) => (
            ...
            <Box sx={{
                ...
                <Pagination color="primary" count={Math.ceil(beginnerWorkout.length / itemsPerPage)} page={page} onChange={handlePageChange} />
            </Box>
