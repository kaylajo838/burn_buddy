            ...
            <Box sx={{
                ...
                <Card sx={{ minWidth: 200, display: 'flex', justifyContent: 'center' }}>
                    <CardActions sx={{ flexDirection: 'column' }}>
                        <CardMedia
                            ...
                            alt="muscle flexing"
                        />
                        <Button size="small" onClick={() => navigate('/beginnerTarget')}>Select By Target Muscle Group</Button>
                    </CardActions>
                </Card>
                ...
                <Card sx={{ minWidth: 200, display: 'flex', justifyContent: 'center' }}>
                    <CardActions sx={{ flexDirection: 'column' }}>
                        <CardMedia
                            ...
                            alt="barbell picture"
                        />
                        <Button size="small" onClick={() => navigate('/beginnerCategory')}>Select By Category</Button>
                    </CardActions>
                </Card>
                ...
                <Card sx={{ minWidth: 200, display: 'flex', justifyContent: 'center' }}>
                    <CardActions sx={{ flexDirection: 'column' }}>
                        ...
                        />
                        <Button size="small" onClick={() => navigate('/beginnerAllWorkouts')}>All Workouts</Button>
                    </CardActions>
                </Card>
            </Box>
