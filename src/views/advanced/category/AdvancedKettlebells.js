...
export default function AdvancedKettlebells() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(advanced => {
                ...
                return advanced.Difficulty === 'Advanced' && advanced.Category && advanced.Category && advanced.Category.includes('Kettlebells')
            })
