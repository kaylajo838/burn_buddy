...
export default function AdvancedBodyweight() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(advanced => {
                ...
                return advanced.Difficulty === 'Advanced' && advanced.Category && advanced.Category && advanced.Category.includes('Bodyweight')
            })
