...
export default function AdvancedCalves() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(advanced => {
                ...
                return advanced.Difficulty === 'Advanced' && advanced.target && advanced.target.Primary && advanced.target.Primary.includes('Calves')
            })
