...
export default function IntermediateStretches() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(intermediate => {
                ...
                return intermediate.Difficulty === 'Intermediate' && intermediate.Category && intermediate.Category && intermediate.Category.includes('Stretches')
            })
