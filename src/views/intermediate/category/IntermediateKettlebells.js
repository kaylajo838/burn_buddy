...
export default function IntermediateKettlebells() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(intermediate => {
                ...
                return intermediate.Difficulty === 'Intermediate' && intermediate.Category && intermediate.Category && intermediate.Category.includes('Kettlebells')
            })
    ...
    <div style={{ marginRight: '40px', marginLeft: '40px', marginBottom: '40px'}}>
        ...
        <Box sx={{
            ...
            <Typography variant='h3' component='h2'>
                Intermediate Kettleball Workouts
            </Typography>
        </Box>
