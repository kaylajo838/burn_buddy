...
export default function IntermediateCables() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(intermediate => {
                ...
                return intermediate.Difficulty === 'Intermediate' && intermediate.Category && intermediate.Category && intermediate.Category.includes('Cables')
            })
