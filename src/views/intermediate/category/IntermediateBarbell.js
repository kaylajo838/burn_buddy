...
export default function IntermediateBarbell() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(intermediate => {
                ...
                return intermediate.Difficulty === 'Intermediate' && intermediate.Category && intermediate.Category && intermediate.Category.includes('Barbell')
            })
