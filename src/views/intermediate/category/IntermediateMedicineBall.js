...
export default function IntermediateMedicineBall() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(intermediate => {
                ...
                return intermediate.Difficulty === 'Intermediate' && intermediate.Category && intermediate.Category && intermediate.Category.includes('MedicineBall')
            })
  ...
  return (
    <div style={{ marginRight: '40px', marginLeft: '40px', marginBottom: '40px'}}>
        <Button sx={{margin: '20px'}} onClick={() => navigate('/intermediateCategory')}>Back</Button>
        <Box sx={{
            display: 'flex',
            ...
            <Typography variant='h3' component='h2'>
                Intermediate Medicine Ball Workouts
            </Typography>
        </Box>
