            ...
            <Box sx={{
                ...
                <Card sx={{ minWidth: 200, display: 'flex', justifyContent: 'center' }}>
                    <CardActions sx={{ flexDirection: 'column' }}>
                        <CardMedia
                            ...
                            alt="muscle flexing"
                        />
                        <Button size="small" onClick={() => navigate('/intermediateTarget')}>Select By Target Muscle Group</Button>
                    </CardActions>
                </Card>
                ...
                <Card sx={{ minWidth: 200, display: 'flex', justifyContent: 'center' }}>
                    <CardActions sx={{ flexDirection: 'column' }}>
                        <CardMedia
                            ...
                            alt="barbell picture"
                        />
                        <Button size="small" onClick={() => navigate('/intermediateCategory')}>Select By Category</Button>
                    </CardActions>
                </Card>
                ...
                <Card sx={{ minWidth: 200, display: 'flex', justifyContent: 'center' }}>
                    <CardActions sx={{ flexDirection: 'column' }}>
                        ...
                        />
                        <Button size="small" onClick={() => navigate('/intermediateAllWorkouts')}>All Workouts</Button>
                    </CardActions>
                </Card>
            </Box>
