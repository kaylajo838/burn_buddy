...
export default function IntermediateObliques() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(intermediate => {
                ...
                return intermediate.Difficulty === 'Intermediate' && intermediate.target && intermediate.target.Primary && intermediate.target.Primary.includes('Obliques')
            })
