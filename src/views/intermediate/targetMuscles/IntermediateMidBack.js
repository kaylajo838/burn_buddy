...
export default function IntermediateMidBack() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(intermediate => {
                ...
                return intermediate.Difficulty === 'Intermediate' && intermediate.target && intermediate.target.Primary && intermediate.target.Primary.includes('Mid back')
            })
    ...
    <div style={{ marginRight: '40px', marginLeft: '40px', marginBottom: '40px'}}>
        ...
        <Box sx={{
            ...
            <Typography variant='h3' component='h2'>
                Intermediate Mid Back Workouts
            </Typography>
        </Box>
