...
export default function IntermediateHamstrings() {
    ...
    const fitnessTest = async () => {
        ...
        try {
            ...
            let workoutJson = result.filter(intermediate => {
                ...
                return intermediate.Difficulty === 'Intermediate' && intermediate.target && intermediate.target.Primary && intermediate.target.Primary.includes('Hamstrings')
            })
  ...
  return (
    <div style={{ marginRight: '40px', marginLeft: '40px', marginBottom: '40px'}}>
        <Button sx={{margin: '20px'}} onClick={() => navigate('/intermediateTarget')}>Back</Button>
        <Box sx={{
            display: 'flex',
            ...
            <Typography variant='h3' component='h2'>
                Intermediate Hamstring Workouts
            </Typography>
        </Box>
